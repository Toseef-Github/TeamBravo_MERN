...
function Home() {
    return (
        ...
        <Carousel variant="light" class = "mx-auto">
         ...
         <Carousel.Item>
         <img class="carousel__minion-image"
      ...
      <Carousel.Item>
        <img class="carousel__bulletTrain-image"
          className="d-block w-100"
        ...
        />
        <Carousel.Caption>
          <h5 href="BulletTrain">Bullet Train</h5>
        </Carousel.Caption>
      </Carousel.Item>

      <Carousel.Item>
        <img class="carousel__thor-image"
          className="d-block w-100"
        ...
        />
        <Carousel.Caption>
          <h5 href="Thor">Thor:Love and Thunder</h5>
        </Carousel.Caption>
      </Carousel.Item>

      <Carousel.Item>
        <img class="carousel__superPets-image"
          className="d-block w-100"
        ...
        />
        <Carousel.Caption>
          <h5 href="Superpets">DC: League of Super-Pets</h5>
        </Carousel.Caption>
      </Carousel.Item>
    </Carousel>
        </body>
